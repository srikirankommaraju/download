...
import 'package:offline_downloads_demo/encryption.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        child: Text('Encrypt Here'),
        onPressed: () {
          Map _map = downloadsListMaps[0];
          String _savedDirectory = _map['savedDirectory'];
          List<FileSystemEntity> _directories =
              Directory(_savedDirectory).listSync(followLinks: true);
          File _file = _directories.isNotEmpty ? _directories?.first : null;
          EncryptionController.encryptData(_file);
        },
      ),
    );
  }
